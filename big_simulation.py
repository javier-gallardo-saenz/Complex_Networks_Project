...
for i in range(len(num_nodes_list)):
    ...
    # # HCM  #
    # ########
    # for gamma_in in inter_power:
    #     for gamma_out in outer_power:
    #         #######
    #         #BASIC#
    #         #######
    ...
    #                 for degree in generate_power_law_degree_sequence(num_nodes // num_comm, gamma=gamma_in, k_min=20)
    #             ]
    ...
    #               f"inner power coefficient{gamma_in} and outer power coefficient {gamma_out}; "
