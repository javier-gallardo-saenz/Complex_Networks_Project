...
# #NOTE: label is the name of the node feature we are doing inference over
...
nx.draw(G, with_labels=True, node_color=node_colors, edge_color="gray", node_size=10, font_size=4)
plt.show()
